...
export const HEADER_MAPS: Record<Era, HeaderMap> = {
  // 1991-1999: EXPEDIENTE + INSTITUCIÓN + DISCIPLINA but no CVU.
  // Headers vary: 1991 plain, 1992 "PAIS (a partir de 1990)", 1995-1999 trailing spaces.
  "pre-cvu": {
    ...EMPTY,
    ...
    subdisciplina: ["SUBDISCIPLINA", "SUBDISCIPLINA "],
    especialidad: ["ESPECIALIDAD", "ESPECIALIDAD "],
    institucion: ["INSTITUCIÓN DE ADSCRIPCIÓN", "INSTITUCIÓN DE ADSCRIPCIÓN "],
    dependencia: ["DEPENDENCIA", "DEPENDENCIA "],
    entidad: ["ENTIDAD FEDERATIVA", "ENTIDAD FEDERATIVA "],
    pais: ["PAIS", "PAIS ", "PAIS (a partir de 1990)"],
    fecha_inicio_vigencia: ["FECHA DE INICIO DE VIGENCIA"],
    fecha_fin_vigencia: ["FECHA DE FIN DE VIGENCIA"],
  },
  // 2022: CVU + NOMBRE (short) + INSTITUCION (no tilde on N)
  "2022": {
    ...EMPTY,
    cvu: ["CVU"],
    nombre: ["NOMBRE"],
    ...
    institucion: ["INSTITUCION DE ADSCRIPCIÓN"],
    dependencia: ["DEPENDENCIA"],
    entidad: ["ENTIDAD FEDERATIVA DE ADSCRIPCIÓN"],
    pais: ["PAÍS DE ADSCRIPCIÓN"],
    fecha_inicio_vigencia: ["FECHA DE INICIO DE VIGENCIA"],
    fecha_fin_vigencia: ["FECHA DE FIN DE VIGENCIA"],
  },
  ...
  // 2024: CVU + NOMBRE DEL INVESTIGADOR + INSTITUCIÓN DE ACREDITACIÓN + CATEGORÍA (accent)
  "2024": {
    ...EMPTY,
    cvu: ["CVU"],
    nombre: ["NOMBRE DEL INVESTIGADOR"],
    ...
    disciplina: ["DISCIPLINA"],
    subdisciplina: ["SUBDISCIPLINA"],
    institucion: ["INSTITUCIÓN DE COMISIÓN", "INSTITUCIÓN DE ACREDITACIÓN"],
    dependencia: ["DEPENDENCIA DE ACREDITACIÓN"],
    entidad: ["UBICACIÓN DE COMISIÓN", "ENTIDAD DE ACREDITACIÓN"],
